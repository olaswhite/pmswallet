              ...
              <header class="page-title-bar">
                <p class="lead">
                    <span class="font-weight-bold display-4"></span>
                     <span class="d-block text-muted h6">Welcome Super Admin Dashboard</span>
                          ...
                          <a href="" class="metric metric-bordered align-items-center">
                            ...
                            <p class="metric-value h3">
                              <sub>
                                ...
                                <h2><button type="button" class="btn btn-primary  rounded">Wallet</button></h2>
                              </sub>
                        ...
                        <div class="col">
                          ...
                          <div  class="metric metric-bordered align-items-center">
                            ...
                            <p class="metric-value h3">
                              <sub>
                                <!-- <i class="oi oi-people"></i> -->
                                <h2><button  class="btn btn-primary  rounded" data-toggle="modal"  data-target="#myTransfer">Transfer Fund</button></h2>
                              </sub>
                              <span class="value "></span>
                            </p>
                          </div>
                        ...
                        <div class="col">
                          ...
                          <a href="../usertails/fund_wallet" class="metric metric-bordered align-items-center">
                            ...
                            <p class="metric-value h3">
                              <sub>
                                <!-- <i class="oi oi-people"></i> -->
                               <h2> <button type="button" class="btn btn-primary  rounded">Buy Airtime</button></h2>
                              </sub>
                              <span class="value "></span>
                            </p>
                          </a>
                   ...
                   <div class="col">
                          ...
                          <a href="" class="metric metric-bordered align-items-center">
                            ...
                            <p class="metric-value h3">
                              <sub>
                                <!-- <i class="oi oi-people"></i> -->
                               <h2> <button type="button" class="btn btn-primary  rounded" >Buy Products</button></h2>
                              </sub>
                              <span class="value "></span>
                            </p>
                          </a>
