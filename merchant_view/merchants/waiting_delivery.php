...
if(isset($_POST['trans'])){
    ...
    $pendingUpdated=$pending->PendingPartnerStatus($submit, 1);
  //   $insertPending=$partner->creditPartnerWallet($username,$productamount);
  //  $insertTrans = $partner->createPartnerTrans($ref, $username,$customername,$productname,$productamount,'Sell');
   ...
   if($pendingUpdated){
    echo "
        ...
        window.location.href='waiting_delivery';
        </script>
";
...
echo "
        <script>
        alert('Sorry,Product not delivered');
        window.location.href='waiting_delivery';
        </script>
";  
}
...
$getPending=$pending->PendingUserList2($username,$sta);
...
$i= $getProduct->fetch(PDO::FETCH_ASSOC);
 ...
 if($partnerstatus==0 && $userstatus==1){
 ...
 echo'
                                        ...
                                        <tr>
                                            ...
                                            <div class="col-sm-6">'.$user_fname.'<br/>'.$user_email.'
                                            <br/>
                                            '.$user_phoneno.'</div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form method="post"  action="waiting_delivery" class="credit-card-div">
