            ...
            <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="../../AuthController_merchant/logout.php">
...
<div class="modal-dialog modal-dialog-scrollable">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../../AuthController_merchant/imageUpload" method="post" enctype="multipart/form-data" >
...
<div>
          <form method="POST" action="../../AuthController_merchant/update" >
