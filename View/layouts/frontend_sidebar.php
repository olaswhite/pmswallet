          ...
          <section class="aside-menu has-scrollable">
            ...
            <nav id="stacked-menu" class="stacked-menu">
              ...
              <ul class="menu">
                ...
                <!-- /.menu-item -->
                <!-- .menu-header -->
                <li class="menu-header">My Wallet Details </li>
                <!-- /.menu-header -->
                ...
                <li class="menu-item has-child">
                  ...
                  <ul class="menu">
                    <li class="menu-item">
                      <a href="fund_wallet" class="menu-link">Fund Wallet</a>
                ...
                <li class="menu-item has-child">
                  ...
                  <ul class="menu">
                  <li class="menu-item">
                      <p  class="menu-link pointer" data-toggle="modal" data-target="#withdraw" >Withdraw</p>
                    </li>
                ...
                <li class="menu-item has-child">
                  ...
                  <ul class="menu">
                    <li class="menu-item">
                      <a href="pms_wallet" class="menu-link">PMS</a>
                    </li>
                    <li class="menu-item">
                      <a href="diesel_wallet" class="menu-link">Diesel</a>
                    </li>
                    <li class="menu-item">
                      <a href="gas_wallet" class="menu-link">Gas</a>
                    </li>
                  </ul>
                  <!-- /child menu -->
                </li>
                ...
                <li class="menu-item has-child">
                  <a href="#" class="menu-link">
                    ...
                    <span class="menu-text">Product Transactions</span>
                  </a>
                  <!-- child menu -->
                  <ul class="menu">
                    <li class="menu-item">
                      <a href="product_transaction" class="menu-link">View Product Transactions</a>
                    </li>
                ...
                <!-- .menu-item -->
                 <li class="menu-item has-child">
                  <a href="#" class="menu-link">
                    ...
                    <span class="menu-text">Product Request</span>
                  </a>
                  <!-- child menu -->
                  <ul class="menu">
                    <li class="menu-item">
                      <a href="product_request" class="menu-link">Make Product Request</a>
                    </li>
                 ...
                 <li class="menu-item has-child">
                  ...
                  <ul class="menu">
                    <li class="menu-item">
                      <a href="product_history" class="menu-link">View Transactions History</a>
                    </li>
