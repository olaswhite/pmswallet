        ...
        <div class="col-md-12 min-vh-100 d-flex flex-column justify-content-center">
            <div class="row">
                <div class="col-lg-6 col-md-8 mx-auto">
                 <h2 class="text-center py-4">Easy Life</h2>
                    <!-- form card login -->
                    <div class="card bg-light">
                       <div class="card-header bg-white">
                        ...
                        <div class="card-body">
                            <form class="form" role="form" autocomplete="off" id="formLogin" novalidate="" method="POST" action="../../Controller/AuthController/log" >
